      ...
      <div className="mt-8 w-full max-w-md relative z-10">
        <div className="bg-bg-secondary/60 backdrop-blur-2xl py-8 px-6 shadow-2xl rounded-3xl border border-border/50 sm:px-10">
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            ...
            <div className="pt-2">
              <Button type="submit" isLoading={loading} fullWidth disabled={loading}>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <Button variant="secondary" onClick={handleGoogleSignIn} type="button" disabled={loading} fullWidth className="bg-bg-primary/50 hover:bg-bg-tertiary">
